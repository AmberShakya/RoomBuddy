...
void view(string username)
{
    ...
    std:cout << "Username : " << result["username"].toString() << std:endl;
    std:cout << "PhoneNo : " << result["PhoneNo"].toString() << std:endl;
    std:cout << "Age : " << result["Age"].toString() << std:endl;
    std:cout << "Gender : " << result["Gender"].toString() << std:endl;
    std:cout << "Interest1 : " << result["Interest1"].toString() << std:endl;
    std:cout << "Interest2 : " << result["Interest2"].toString() << std:endl;
}
...
filter_builder << "key" << "value"; // This is the condition for selecting the document to update.
